...
int TabManager::createSubModules(QString path_to_ini_file)
{
	...
	m_mapController->init(_map_settings, _db_manager_bla, _db_manager_evil);
...
//    _model_spectrum->set_db(_db_manager_spectrum);
	...
	NiippController* _niipp1 = new NiippController(100, tr("СПИП ДД-1"), latlon1, _router, m_mapController, this);

	QPointF latlon2;
	latlon2.setX(42.634183);
	latlon2.setY(41.912167);
	NiippController* _niipp2 = new NiippController(101, tr("СПИП ДД-2"), latlon2, _router, m_mapController, this);
