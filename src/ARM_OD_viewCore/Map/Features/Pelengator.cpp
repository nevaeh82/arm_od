#include "PelengatorFeature.h"


PelengatorFeature::PelengatorFeature( PwGisWidget* pwwidget,
...
PelengatorFeature::~PelengatorFeature()
{
}
...
void PelengatorFeature::updatePeleng( int postId, double lat, double lon,
	double direction )
{
...
void PelengatorFeature::setPointEvilPeleng( int id, QPointF point )
{
	PwGisPointList* p;
