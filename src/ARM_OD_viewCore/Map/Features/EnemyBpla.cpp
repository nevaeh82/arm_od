#include "BplaFeature.h"


BplaFeature::BplaFeature( PwGisWidget* pwwidget, QString layerId ) :
	m_pwwidget( pwwidget )
{
...
BplaFeature::~BplaFeature()
{
}

void BplaFeature::add(int id, QPointF sko, QVector<QPointF> *track,
	double alt )
{
	QString name;
